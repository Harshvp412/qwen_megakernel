...
def main():
    ...
    # Test 4: Compare with HF directly
    print("\n[Test 4] Comparing with HuggingFace (first 3 tokens)")
    ...
    hf_tokens = output[0, -3:].tolist()
    print(f"  HF tokens: {hf_tokens}")
    print(f"  HF text: {tokenizer.decode(hf_tokens, skip_special_tokens=True)}")
